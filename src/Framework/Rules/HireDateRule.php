...
class HireDateRule implements RuleInterface
{
    public function validate(array $formData, string $field, array $params): bool
    {
        ...
        $dob = DateTime::createFromFormat('Y-m-d', $params[1]);
    ...
    //    $DOB = (clone $now)->sub(new DateInterval('P18Y'));
    ...
    {
        return "Invalid date For Hiring.";
    }
}