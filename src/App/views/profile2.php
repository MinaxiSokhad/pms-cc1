    ...
    <div class="container">
        ...
        <table class="profile-table">
            ...
            <tr>
                ...
                <td><?php echo e($profile['maritalStatus']); ?></td>
            </tr>
            <tr>
                <th>Mobile No:</th>
                <td><?php echo e($profile['mobileNo']); ?></td>
            </tr>
            <tr>
                <th>Address:</th>
            ...
            <tr>
                <th>Date of Birth:</th>
                <td><?php echo e($profile['dob']); ?></td>
            </tr>
            <tr>
                <th>Hire Date:</th>
                <td><?php echo e($profile['hireDate']); ?></td>
            </tr>
            <tr>
                <th>Status:</th>
                <td><?php echo $profile['status'] == '1' ? 'Active' : 'Inactive'; ?></td>
            </tr>
            <tr>
                <th>User Type:</th>
                <td><?php echo $profile['user_type'] == 'A' ? 'Admin' : 'Employee'; ?></td>
            </tr>
            <tr>
                <th>Created At:</th>
...
<form id="editprofile" method="post">
 ...
 <div class="mb-3">
  <label class="small mb-1" for="name">Full Name<span style="color: red;"> * </span></label>
    <input class="form-control" type="text" value="<?php echo e($oldFormData['name'] ?? ''); ?>" id="name" name="name" >
...
<div class="col-md-6">    
    ...
    <input class="form-control" type="text" value="<?php echo e($oldFormData['email'] ?? ''); ?>" id="email" name="email" >
    ...
    <input class="form-control" type="text" value="<?php echo e($oldFormData['country'] ?? ''); ?>" id="country" name="country">
    ...
    <input class="form-control" type="text" value="<?php echo e($oldFormData['state'] ?? ''); ?>" id="state" name="state">
    ...
    <input class="form-control" type="text" value="<?php echo e($oldFormData['city'] ?? ''); ?>" id="city" name="city">
    ...
    <input class="form-control" type="text" value="<?php echo e($oldFormData['mobileNo'] ?? ''); ?>" id="mobileNo" name="mobileNo"  placeholder="Enter 10-digit mobile number">
    ...
    <textarea class="form-control" id="address" name="address"><?php echo e($oldFormData['address'] ?? ''); ?></textarea>
    ...
    <input class="form-control" type="date" value="<?php echo e($oldFormData['dob'] ?? ''); ?>" id="dob" name="dob">
    ...
    <input class="form-control" type="date" id="hireDate" value="<?php echo e($oldFormData['hireDate'] ?? ''); ?>" name="hireDate">
                  ...
                  <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                      ...
                      <li>
                        ...
                        <a class="dropdown-item" href="/profile/<?php echo e($_SESSION['user'])?>">My profile</a>
                        <a class="dropdown-item" href="/timesheets">My Timesheets</a>
                        <a class="dropdown-item" href="staff/editProfile/<?php echo e($_SESSION['user'])?>">Edit Profile</a>
                        <!-- <div class="dropdown-divider"></div>
