          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <a href="/createcustomer" class="nav-link btn btn-success create-new-button" id="createbuttonDropdown"  aria-expanded="false" href="#">+ Create New Customer</a>
            ...
            $storage = "http://192.168.1.30/storage/uploads/";
                $defaultImage = "http://192.168.1.30/storage/uploads/download.png";
