...
<div class="container-xl px-4 mt-4">
    ...
    <div class="row"  style="color:white">
        <div class="col-xl-4">
            ...
            $storage = "http://192.168.1.23/storage/uploads/";
                $defaultImage = "http://192.168.1.23/storage/uploads/download.png";
            ...
            ?>
              ...
              <div class="card-body text-center" >
                    ...
                    <img class="img-account-profile rounded-circle mb-2" src="<?php echo e($profileImage) ?>" />
                    <!-- Profile picture help block-->
                    <div class="card-header" style="color:white"><?php echo e($profile['name']); ?></div>
 ...
 ?></div>
 <div class="mb-3">
  <label class="small mb-1" for="name">Full Name<span style="color: red;"> * </span></label>
    <input class="form-control" type="text" value="<?php echo e($editProfile['name'] ?? ''); ?>" id="name" name="name" >
...
<div class="col-md-6">    
    ...
    <input class="form-control" type="text" value="<?php echo e($editProfile['email'] ?? ''); ?>" id="email" name="email" >
    ...
    <?php if (array_key_exists('email', $errors)) : ?>
            ...
            <div class="col-md-6">
    <label class="small mb-1" for="password">Password <span style="color: red;"> * </span></label>
    ...
    <input class="form-control" type="text" value="<?php echo e($editProfile['country'] ?? ''); ?>" id="country" name="country">
    ...
    <?php if (array_key_exists('country', $errors)) : ?>
            ...
            <div class="col-md-6">
    <label class="small mb-1" for="state">State <span style="color: red;"> * </span></label>
    <input class="form-control" type="text" value="<?php echo e($editProfile['state'] ?? ''); ?>" id="state" name="state">
    ...
    <?php if (array_key_exists('state', $errors)) : ?>
            ...
            <div class="row gx-3 mb-3">
            <div class="col-md-6">
    <label class="small mb-1" for="city">City <span style="color: red;"> * </span></label>
    <input class="form-control" type="text" value="<?php echo e($editProfile['city'] ?? ''); ?>" id="city" name="city">
    ...
    <textarea class="form-control" id="address" name="address"><?php echo e($editProfile['address'] ?? ''); ?></textarea>
    ...
    <option value=""></option>
      ...
      <option value="F"<?php echo ($editProfile['gender'] ?? '') === 'F' ? 'selected' : ''; ?>>Female</option>
      <option value="O"<?php echo ($editProfile['gender'] ?? '') === 'O' ? 'selected' : ''; ?>>Others</option>
    </select>
    ...
    <?php if (array_key_exists('gender', $errors)) : ?>
            ...
            <div class="col-md-6">
    <label class="small mb-1" for="maritalStatus">Marital Status <span style="color: red;"> * </span></label>
    <select class="form-control" id="maritalStatus" name="maritalStatus">
    <option value=""></option>
      <option value="S"<?php echo ($editProfile['maritalStatus'] ?? '') === 'S' ? 'selected' : ''; ?>>Single</option>
      <option value="M"<?php echo ($editProfile['maritalStatus'] ?? '') === 'M' ? 'selected' : ''; ?>>Married</option>
      <option value="W"<?php echo ($editProfile['maritalStatus'] ?? '') === 'W' ? 'selected' : ''; ?>>Widowed</option>
      <option value="D"<?php echo ($editProfile['maritalStatus'] ?? '') === 'D' ? 'selected' : ''; ?>>Divorced</option>
    </select>
    ...
    <?php if (array_key_exists('maritalStatus', $errors)) : ?>
            ...
            <?php endif; ?>
             ...
             <div class="row gx-3 mb-3">
            <div class="col-md-6">
    <label class="small mb-1" for="mobileNo">Mobile Number <span style="color: red;"> * </span></label>
    <input class="form-control" type="text" value="<?php echo e($editProfile['mobileNo'] ?? ''); ?>" id="mobileNo" name="mobileNo"  placeholder="Enter 10-digit mobile number">
    ...
    <?php if (array_key_exists('mobileNo', $errors)) : ?>
      ...
      <div class="row gx-3 mb-3">
      <div class="col-md-6">
    <label class="small mb-1" for="dob">Date of Birth <span style="color: red;"> * </span></label>
    <input class="form-control" type="date" value="<?php echo e($editProfile['dob'] ?? ''); ?>" id="dob" name="dob">
    <?php if (array_key_exists('dob', $errors)) : ?>
            ...
            <div class="col-md-6">
    <label class="small mb-1" for="hire_date">Hire Date <span style="color: red;"> * </span></label>
    <input class="form-control" type="date" id="hireDate" value="<?php echo e($editProfile['hireDate'] ?? ''); ?>" name="hireDate">
    ...
    <label class="small mb-1" for="image">Upload Image <span style="color: red;"> * </span></label>
