<?php include $this->resolve("partials/_header.php"); ?>
  <body>
    ...
    <div class="main-body" >
          ...
          <div class="card-body">
          <h2 style="color:white">User Profile</h2></div>
          ...
          <div class="row gutters-sm">
            ...
            ?>
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="<?php echo e($profileImage) ?>" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
              ...
              <div class="card-header">Account Details</div>
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    else if($profile['gender'] === 'F'){ $profile['gender'] = "Female";}
                    else if($profile['gender'] === 'O'){ $profile['gender'] = "Other";}
                    ?>
                    <div class="col-sm-9 text-secondary">
                  ...
                  <div class="row">
                    ...
                    <?php 
                    if($profile['maritalStatus'] === 'S'){ $profile['maritalStatus'] = "Single";}
                    else if($profile['maritalStatus'] === 'M'){ $profile['maritalStatus'] = "Married";}
                    else if($profile['maritalStatus'] === 'W'){ $profile['maritalStatus'] = "Widowed";}
                    else if($profile['maritalStatus'] === 'D'){ $profile['maritalStatus'] = "Divorced";}
                    ?>
                    <div class="col-sm-9 text-secondary">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info " href="/staff/editProfile/<?php echo e($_SESSION['user']); ?>">Edit</a>
                    </div>
                  </div>
                </div>
              </div>
